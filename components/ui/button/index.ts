...
export const buttonVariants = cva("", {
    variants: {
        variant: {
            default:
                "text-white rounded-full bg-zblack border-[3px] border-zgray outline outline-[3px] outline-zblack duration-300 ease-in-out hover:bg-white hover:border-white hover:text-zblack grid place-items-center  disabled:bg-white disabled:border-white disabled:text-zblack",
